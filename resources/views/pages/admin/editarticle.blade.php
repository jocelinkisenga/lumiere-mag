                    ...
                    <form class="forms-sample" method="POST" action="{{ route("posts.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="">
                                    <input type="text" name="title" class="form-control" id="exampleInputUsername2" placeholder="" value="{{ $post->title }}">
                                </div>
                    ...
                    <label for=" exampleInputEmail2" class="col-sm-3 col-form-label">image de couverture</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="exampleInputEmail2" name="tags" placeholder="ex: technologie, culture, a la une " value="@foreach($post->tags as $tag)
                                     {{ $tag->name}} @endforeach">
                                </div>
